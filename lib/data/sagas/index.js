...
import { prefixName, stableKeccak256, makeAssignment } from "../../helpers";
    ...
    switch (request.type) {
      ...
      case "code":
        ...
        if (address in instances) {
          ...
          //I don't want to write a new ethers saga, so let's just use
          //obtainBinaries with a one-element array
          debug("fetching binary");
          let binary = (yield* ethers.obtainBinaries([address], blockNumber))[0];
